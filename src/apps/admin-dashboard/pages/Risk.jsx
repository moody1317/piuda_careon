...
const RISK_ROWS = [
    ...
    { avatar: '이순', name: '이순자', age: 83, symptom: '반복 발화·기억 혼동 표현↑',     manager: '김민지', date: '05.26', status: '긴급', score: 88 },
    { avatar: '정대', name: '정대호', age: 79, symptom: '낙상 위험·수면장애 지속',        manager: '이성희', date: '05.25', status: '긴급', score: 84 },
    { avatar: '최옥', name: '최옥순', age: 75, symptom: '약 복용 불규칙 2회 연속',        manager: '이성희', date: '05.25', status: '주의', score: 62 },
    { avatar: '강순', name: '강순희', age: 81, symptom: '우울감 표현 증가 추이',          manager: '박지수', date: '05.24', status: '주의', score: 58 },
    { avatar: '윤기', name: '윤기철', age: 85, symptom: '식욕 감소·체중 변화',           manager: '박지수', date: '05.24', status: '주의', score: 54 },
    { avatar: '한복', name: '한복순', age: 80, symptom: '수면 불규칙 패턴',              manager: '한미래', date: '05.23', status: '주의', score: 50 },
    { avatar: '오철', name: '오철수', age: 76, symptom: '반복 발화 시작 단계',           manager: '오은지', date: '05.22', status: '주의', score: 45 },
];
